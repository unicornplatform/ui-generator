...
class Toggle extends Component {
  constructor(props) {
    ...
    this.state = {
      active:
        (this.props.type == 0 && this.props.dark == 1) ||
        (this.props.type == 1 && this.props.mockup == 1)
          ? 1
          : 0,
    };
  }
      ...
      return (
        <div className="toggle">
          ...
          <button
            ...
            className={
              "toggle__button " +
              (this.props.dark == 1 ? "toggle__button_active" : "")
            }
          ></button>
        </div>
      );
      ...
      return (
        <div className="toggle">
          ...
          <button
            ...
            className={
              "toggle__button " +
              (this.props.mockup == 1 ? "toggle__button_active" : "")
            }
          ></button>
        </div>
      );

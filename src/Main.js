        ...
        return (
            <div className="main">
                ...
                <div className="main__type mobile-only">
                    ...
                    <Switch className="main__switch" setType={this.props.setType} type={this.props.type}/>
                </div>
                ...
                <div className="main__result">
                    <div className="main__text-content desktop-only">
                        <div className="main__title-container">
                            <h2 className="main__result-title h2-title js-result-title">
                                Generate and Download<br/>Mockup UI
                            </h2>
                            <Spinner/>
                        </div>
                        <div className="main__subtitle">

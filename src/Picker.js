  ...
  render() {
    ...
    return (
      <button
        className={
          "picker__button " +
          (this.props.i == this.props.selected ? "picker__button_active" : "")
        }
      ...
      >
        <img
          ...
          src={
            this.color[this.props.i] === "#FAFAFA" ||
            this.color[this.props.i] === "#FFDD59"
              ? "check_black.svg"
              : "check.svg"
          }
          alt=""
...
class Picker extends Component {
  ...
  render() {
    return (
      <div
        className={
          "picker " + (this.props.className ? this.props.className : "")
        }
      >
        <Color

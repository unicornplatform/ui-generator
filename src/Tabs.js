  ...
  render() {
    return (
      <div className="tabs">
        <div
          className={
            "tabs__container tabs__container_" +
        ...
        >
          <Tab
            ...
            deviceType={this.props.type}
          >
            {this.props.type == 1 ? "Sign\xa0up" : "Dashboard\xa01"}
          </Tab>
          <Tab
            onClick={this.changeValue}
            type={1}
            ...
            deviceType={this.props.type}
          >
            {this.props.type == 1 ? "Messenger" : "Dashboard\xa02"}
          </Tab>
          <Tab
            onClick={this.changeValue}
            type={2}
            ...
            deviceType={this.props.type}
          >
            {this.props.type == 1 ? "Profile" : "Dashboard\xa03"}
          </Tab>
          <Tab
            onClick={this.changeValue}
            type={3}
